    ...
    return (
        <div className="homeCard">
            ...
            <div className="mobileSubjectMenu"> 
                <MenuCard url="/fisica/vectores-practica" img="fisicaIcon.png" title="Vectores" />

                <MenuCard url="/fisica/mru-practica" img="fisicaIcon.png" title="M.R.U" />

                <MenuCard url="/fisica/mrua-practica" img="fisicaIcon.png" title="M.R.U.A." />

                <MenuCard url="/fisica/caida-libre-practica" img="fisicaIcon.png" title="Caída libre" />

                <MenuCard url="/fisica/tiro-vertical-practica" img="fisicaIcon.png" title="Tiro vertical" />

                <MenuCard url="/fisica/tiro-parabolico-practica" img="fisicaIcon.png" title="Tiro parabólico" />

                <MenuCard url="/fisica/dinamica-practica" img="fisicaIcon.png" title="Dinámica" />

                <MenuCard url="/fisica/torque-practica" img="fisicaIcon.png" title="Torque" />

                <MenuCard url="/fisica/trabajo-practica" img="fisicaIcon.png" title="Trabajo" />
            </div>
