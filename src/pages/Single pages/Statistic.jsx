        ...
        <div className="cardEnglish mb-5 shadow" data-aos="fade-up" data-aos-duration="700">
          ...
          <div>
            ...
            <div className="collapse"  id="reglaTresSimple">
              ...
              <h6>Fórmula</h6>
              <img src="/img/regla-3.jpg" alt="" className="reglaTresDirecta rounded-3" /> <br /><br />
              ...
              <p>
                ...
                <br />
                <img src="/img/regla-3-ejemplo.jpg" className="reglaTresDirecta rounded-3" alt="" /><br /><br />
              ...
              <h6>Fórmula</h6>
              <img src="/img/regla-3-inversa.jpg" alt="" className="reglaTresDirecta rounded-3" /><br /><br />
              <p><Latex>{reglaTresInversa}</Latex></p>
              <br /><br />
              <h6>Ejemplo</h6>
              <p>
                Si Tres personas tardan 4 días en montar un escenario. ¿Cuánto tardarán seis personas? <br />
                <img src="/img/regla-3-inversa-ejemplo.jpg" alt="" className="reglaTresDirecta rounded-3" /> <br /><br />
          ...
          <div>
            ...
            <div className="collapse"  id="medidasSimetriaAsimetria">
              ...
              <img src="/img/campanaGauss.png" alt="" className="campanaGauss rounded-3" /> <br /> <br />
