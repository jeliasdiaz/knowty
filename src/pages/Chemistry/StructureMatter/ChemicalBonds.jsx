    ...
    return (
        <div className="homeCard">
            ...
            <div className="subjectCard mb-5 ownShadow" data-aos="fade-up" data-aos-duration="700" data-aos-once="true">
                ...
                <p>
                    Aunque la diferencia de electronegatividades no es tan grande (diferencia entre 0.4 y 0.7), aun es lo suficientemente fuerte como para que los electrones están más atraídos a un lado del enlace que del otro.
                    El costado donde están más los electrones presenta una carga parcialmente negativa, contrario del sitio opuesto que tiene una carga parcialmente positiva. Es gracias a ello que la molécula presenta polos.
                </p>
                <br />

                <h5>Enlace covalente no polar</h5>
                <p>
                    Al ser la diferencia de electronegatividades tan mínima (diferencia entre 0 y 0.4), la densidad de electrones en ambos lados del enlace es casi la misma, por lo que al contrario del enlace polar, este no presenta ningún polo.
                </p>
