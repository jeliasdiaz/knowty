    ...
    return (
        <div className="homeCard">
            ...
            <div className="subjectCard mb-5 ownShadow" data-aos="fade-up" data-aos-duration="700" data-aos-once="true">
                <p>Las propiedades de la materia se refieren a las características y comportamientos que describen cómo interactúa y se presenta la materia en sus diferentes estados. Estas propiedades pueden clasificarse en generales y específicas.</p>
                <hr />
                <h4>Generales</h4>
                <div>
                    <p>
