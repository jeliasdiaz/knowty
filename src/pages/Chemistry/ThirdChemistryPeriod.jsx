        ...
        <div>
          ...
          <div>
            <CollapseInformation name="Partes de una ecuación" id="partesEcuacion" >
              <img src="/img/partes-ecuacion-quimica.svg" alt="Partes ecuación química" className="rounded-3 revealing-image" />
            </CollapseInformation>
            <hr />
          </div>
          ...
          <div>
            <CollapseInformation name="Balanceo de una ecuación química" id="balanceoEcuacion" >
              ...
              <CollapseInformation name="Balanceo por método óxido reducción" id="balanceoRedox" >
                ...
                <p>
                  Ejemplo: <br />
                  <img src="/img/metodoRedox.svg" alt="Método redox" className="w-75 rounded-3 revealing-image" />
                  <br /> <br />
          ...
          <div>
            <CollapseInformation name="Estequiometría" id="eestequiometria" >
              <p>
                ...
                <br />
                <img src="/img/mol-mol.svg" alt="Mol - mol" className="w-80 rounded-3 revealing-image" /><br />
                ...
                <img src="/img/mol-gramo.svg" alt="Mol - gramo" className="w-80 rounded-3 revealing-image" /><br />
                ...
                <img src="/img/gramo-mol.svg" alt="Gramo - mol" className="w-80 rounded-3 revealing-image" /><br />
                ...
                <img src="/img/gramo-gramo.svg" alt="Gramo - gramo" className="w-80 rounded-3 revealing-image" /><br />
