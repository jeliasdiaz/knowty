        ...
        <div className="homeCard">
            ...
            <div className="subjectCard mb-5 ownShadow" data-aos="fade-up" data-aos-duration="700" data-aos-once="true">
                <p>
                    ...
                    <br />
                    <img src={isDarkMode === "dark" ? "/img/mol-molDark.svg" : "/img/mol-mol.svg"} alt="Mol - mol" className="w-80 rounded-3 revealing-image" /><br />
                    ...
                    <img src={isDarkMode === "dark" ? "/img/mol-gramoDark.svg" : "/img/mol-gramo.svg"} alt="Mol - gramo" className="w-80 rounded-3 revealing-image" /><br />
                    ...
                    <b>Gramo - mol</b> <br />
                    Teniendo en cuenta la siguiente ecuación: <br />
                    <Latex>{`$3Cu + 8NO_3 \\rightarrow 3Cu(NO_3)_2 + 2NO + 4H_2O$`}</Latex> <br />
                    ¿Cuántas moles de HNO3 son necesarias para preparar 0,75 gr de Cu(NO3)2? <br />

                    <img src={isDarkMode === "dark" ? "/img/gramo-molDark.svg" : "/img/gramo-mol.svg"} alt="Gramo - mol" className="w-80 rounded-3 revealing-image" /><br />
                    ...
                    <img src={isDarkMode === "dark" ? "/img/gramo-gramoDark.svg" : "/img/gramo-gramo.svg"} alt="Gramo - gramo" className="w-80 rounded-3 revealing-image" /><br />
