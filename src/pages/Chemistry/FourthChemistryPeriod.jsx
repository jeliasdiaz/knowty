        ...
        <div className="homeQuimica" id="geometria">
            ...
            <div className="cardQuimica mb-5 shadow" data-aos="fade-up" data-aos-duration="700">
                <div>
                    ...
                    <div>
                        <h2>Rendimiento</h2>
                        <p>En primera instancia, las reacciones que se llevan a cabo, no siempre tienen un 100% de eficiencia. Esto se debe a la producción de reacciones secundarias, de modo que el reactivo límite no se transforma completamente en productos.
                            <br /><br />
