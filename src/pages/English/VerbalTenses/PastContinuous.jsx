            ...
            <div className="englishCardContainer" data-aos="fade-up" data-aos-duration="600" data-aos-once="true">
                <div className="englishCard ownShadow">
                    ...
                    <p className="mt-3">
                        ...
                        <br />
                        <small className="ms-3"><Tooltip content={<span>Él estaba corriendo por la calle cuando recibió una llamada de su madre.</span>} text={<span>He was running in the street when he received a call from his mom.</span>} id="HeWasRunningInTheStreetWhen"/></small>
                    </p>
                </div>
            </div>
            ...
            <div className="englishCardContainer">
                <div className="englishCardStructure ownShadow" data-aos="fade-up" data-aos-duration="600" data-aos-once="true">
                    ...
                    <p className="mt-3">
                        <span className="fw-semibold">Ejemplo:</span>
                        <br />
                        <small className="ms-3"><Tooltip content={<span>Estaba corriendo en el campo</span>} text={<span>He was running in the field</span>} id="HeWasRunningInThe field"/></small>
                    </p>
                </div>
                <div className="englishCardStructure ownShadow" data-aos="fade-up" data-aos-duration="600" data-aos-once="true">
                    ...
                    <p className="mt-3">
                        <span className="fw-semibold">Ejemplo:</span>
                        <br />
                        <small className="ms-3"><Tooltip content={<span>No estaba corriendo en el campo</span>} text={<span>I was not running in the field.</span>} id="IWasNotRunningInTheField."/></small>
                    </p>
                </div>
                <div className="englishCardStructure ownShadow" data-aos="fade-up" data-aos-duration="600" data-aos-once="true">
                    ...
                    <p className="mt-3">
                        <span className="fw-semibold">Ejemplo:</span>
                        <br />
                        <small className="ms-3"><Tooltip content={<span>¿Estaba corriendo en el campo?</span>} text={<span>Was I running in the field?</span>} id="WasIRunningInTheField?"/></small>
                    </p>
                </div>
            </div>
