        ...
        <div className="homeCard">
            ...
            <div className="subjectCard ownShadow" data-aos="fade-up" data-aos-duration="700" data-aos-once="true">
                ...
                <CollapseInformation name="Fase M">
                    <p>
                        La fase M o mitótica, es la otra fase del ciclo celular, en esta se dan dos procesos principales que son la mitosis y la citocinesis. <br />
                        ...
                        <br />
                        <br />
                        De esta manera, La citocinesis toma lugar en el proceso, culminando la división celular; ocurre después de la mitosis, en este se divide el citoplasma de la célula madre para la correcta división de las células hijas. Este proceso inicia durante la Anafase o Telofase, dependiendo de la célula. La citocinesis es diferente en células animales y vegetales, pues esta ultima posee una rígida pared celular. Mientras que en la animal se forma un surco de contracción llamado anillo contráctil el cual estrangula el citoplasma hasta dividir las células, la vegetal forma una estructura llamada placa celular en el plano ecuatorial de la célula. Se sintetizan y depositan nuevos componentes de la pared celular, como celulosa y otros polisacáridos, en la región de la placa celular. Estos nuevos materiales de la pared celular se fusionan y forman una lámina media, que luego se convierte en las paredes celulares primarias de las células hijas.
                    </p>
                </CollapseInformation>
            </div>
        </div>
