    ...
    return (
        <div className="homeCard">
            ...
            <div className="subjectCard mb-5 ownShadow" data-aos="fade-up" data-aos-duration="700" data-aos-once="true">
                <div>
                    <CollapseInformation name="Liberalismo" id="liberalismo" >
                        <ul>
                ...
                <div>
                    <CollapseInformation name="Neoliberalismo" id="neoliberalismo" >
                        <ul>
                ...
                <div>
                    <CollapseInformation name="Marxismo" id="marxismo" >
                        <ul>
                ...
                <div>
                    <CollapseInformation name="Anarquismo" id="anarquismo" >
                        <ul>
                ...
                <div>
                    <CollapseInformation name="Positivismo" id="positivismo" >
                        <ul>
