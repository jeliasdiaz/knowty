...
export const ArmedGroups = () => {
  return (
    <div className="homeCard">
      <TopWave />
      <SectionTitle title="Movimientos guerrilleros" />
      ...
      >
        <div>
          <CollapseInformation name="FARC" id="farc">
            ...
            <p>
              <span className="fw-semibold">Filosofía:</span> Marxista -
              Leninista
            </p>
            <p>
              <span className="fw-semibold">Origen:</span> Surgen durante el
              periodo de "la violencia", luego del asesinato de Gaitán
            </p>
            <p>
              <span className="fw-semibold">Motivaciones:</span> Representar a
              la población campesina ante el manejo de las tierras en manos de
              pocos. Es de añadir que las FARC se originan como grupos de
              campesinos en contra del estado.
            </p>
            <p>
              <span className="fw-semibold">Contexto internacional:</span>{" "}
              Guerra fría, a partir de esta, cuba adopta ciertos ideales. Surge
              la revolución cubana, de la cual Gaitán adopta ideales marxistas a
              favor de los campesinos; luego de ser asesinado, las FARC adoptan
              esta ideología.
            </p>
            ...
            <ul>
              ...
              <li>
                Posteriormente, tergiversan sus ideales debido a que en un
                principio se involucran en "negocios" como el narcotráfico para
                cumplir sus cometidos. Sin embargo, se envuelven en secuestros,
                lavados de dinero, etc.
              </li>
            </ul>
            <span className="fw-semibold">Extras</span>
            <ul>
              <li>
                Alias Timochenko es quien participa en los acuerdos de paz en
                2016.
              </li>
              <li>
        ...
        <div>
          <CollapseInformation name="ELN" id="eln">
            ...
            <p>
              <span className="fw-semibold">Fundador:</span> Fabio Vásquez
              Castaño <br />
              <span className="fw-semibold">Máximo pensador:</span> Camilo
              Torres <br />
              <span className="fw-semibold">Base teórica:</span> Revolución
              cubana <br />
            </p>
            <span className="fw-semibold">Líderes:</span>
            <ul>
            ...
            <ul>
              <li>
                Proviene de estudiantes universitarios, reconocidos por su buena
                preparación académica. Esta es su diferencia con las FARC,
                debido a que esta última, surge de grupos campesinos.
              </li>
            ...
            <ul>
              <li>
                Coce = Comando central, se encarga de las decisiones políticas,
                económicas y demás.
              </li>
              <li>
                Teología de la liberación = Como los católicos Jesuitas buscaron
                cambiar las condiciones de vida de las personas.
              </li>
            </ul>
          </CollapseInformation>
          <hr />
        ...
        <div>
          <CollapseInformation name="EPL" id="epl">
            ...
            <ul>
              ...
              <li>
                En 1991 se firman acuerdos de paz con el presidente César
                Gaviria. No obstante, parte de la guerrilla no se acoge a estos
                acuerdos de paz.
              </li>
            </ul>
            <span className="fw-semibold">Extras:</span>
        ...
        <div>
          <CollapseInformation name="M-19" id="m-19">
            ...
            <ul>
              ...
              <li>
                Se enfocaron en las zonas urbanas debido a que se percatan que
                en las zonas rurales el estado no presta atención.
              </li>
            </ul>
