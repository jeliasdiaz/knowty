            ...
            <div className="subjectCard mb-5 ownShadow" data-aos="fade-up" data-aos-duration="900" data-aos-once="true">
                ...
                <div>
                    <CollapseInformation name="Movimientos sociales (Latinoamérica)" id="movimientosSocialesAmerica" >
                        ...
                        <p>De este tema ya se ha hablado en la sección correspondiente al <Link to="/movimientos-armados" className="text-decoration-none">tercer periodo de Sociales</Link>.</p>
                    </CollapseInformation>
                </div>
            </div>
        </div>
