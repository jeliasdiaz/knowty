    ...
    <>
      <section className="fisicaMenu">
        ...
        <div className="fisicaSubjectMenu">
          <NavLink to="/geometria_1" className="link-secondary text-decoration-none text-dark">
          ...
          <NavLink to="/geometria_2" className="link-secondary text-decoration-none text-dark">
          ...
          <NavLink to="/geometria" className="link-secondary text-decoration-none text-dark">
            <div className="subjectLink d-flex shadow mt-3" data-aos="zoom-in-down" data-aos-duration="1400">
              <img src="/img/geometriaIcon.png" alt="" className="w-25 pe-2" />
          ...
          <NavLink to="/geometria_4" className="link-secondary text-decoration-none text-dark">
            <div className="subjectLink d-flex shadow mt-3" data-aos="zoom-in-down" data-aos-duration="1400">
              <img src="/img/geometriaIcon.png" alt="" className="w-25 pe-2" />
