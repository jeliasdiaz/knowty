    ...
    return (
        <div className="infoPage">
            ...
            <div className="infoOne text-center" data-aos="zoom-in" data-aos-duration="800">
                ...
                <img src="/img/knowty.png" alt="Knowty logo" className="ImgInfo" data-aos="fade-in" data-aos-duration="600" data-aos-once="true" />
            </div>
            <div className="flex-1 cardsInfoSection">
                <div className="cardInfo ownShadow" data-aos="fade-down" data-aos-duration="600" data-aos-once="true">
                    <h3>Misión</h3>
                ...
                <div className="cardInfo ownShadow" data-aos="fade-down" data-aos-duration="800" data-aos-once="true">
                    <h3>Visión</h3>
                ...
                <div className="cardInfo ownShadow" data-aos="fade-down" data-aos-duration="1000" data-aos-once="true">
