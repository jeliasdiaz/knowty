      ...
      <div className="footerContent container">
        <div className="textFooter d-none d-md-block d-lg-block">
          ...
          <div className="d-flex justify-content-center">
            ...
            <MembersCard
              name="Andy Solano"
              description="Encargado de las ilustraciones del proyecto."
              icon={<BsMegaphoneFill size={34} />}
              animationduration={1000}
            />

            <MembersCard
              name="Danna Sanchez"
              description="Encargado del area de humanidades dentro de la página."
              icon={<BsMegaphoneFill size={34} />}
            ...
            <MembersCard
              name="David Cáceres"
              description="Encargado de la creación de videos para el canal de YouTube."
              icon={<AiFillYoutube size={36} />}
        ...
        <div className="textFooter d-block d-sm-none">
          ...
          <div>
            <MembersCard
              ...
              description="Creador del proyecto, página y encargado del canal YouTube."
              icon={<HiCode size={34} />}
              iconTwo={<AiFillYoutube size={36} animationduration={1000} />}
              optionalLink="https://jeliasdiaz.netlify.app/"
              optionalClass="pt-4 w-75 mx-auto"
            />
          </div>
