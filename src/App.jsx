...
import {
	...
	PowerPractice,
	PerformancePractice,
	KineticEnergyPractice,
	GravitationalPotentialEnergyPractice,
} from './pages/Physic/'
			...
			<BrowserRouter>
				<ScrollToTop>
					...
					<Routes>
						...
						<Route
							path='/fisica/potencia-practica'
							element={<PowerPractice />}
						/>
						<Route
							path='/fisica/rendimiento-practica'
							element={<PerformancePractice />}
						/>
						<Route
							path='/fisica/energia-cinetica-practica'
							element={<KineticEnergyPractice />}
						/>
						<Route
							path='/fisica/energia-gravitatoria-practica'
							element={<GravitationalPotentialEnergyPractice />}
						/>
